    ...
    <div className="wrap">
      ...
      <style>{`
        ...
        .search {
          ...
          color: #f0f0f8;
          box-shadow: 0 6px 18px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.1);
          outline: none;
          font-size: 0.95rem;
        }
        ...
        .chip:hover { transform: translateY(-3px) scale(1.005); box-shadow: 0 20px 44px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.18); background: rgba(255,255,255,0.13); }
