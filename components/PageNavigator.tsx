...
const art = [['Index','/'],['Work','/work'],['Skills','/skills'],['About','/about'],['Contact','/contact']] as const;

export function PageNavigator() {
  const { mode } = useMode(); const pathname = usePathname(); const [open,setOpen] = useState(false);
  const pages = mode === 'engineer' ? engineering : art;
