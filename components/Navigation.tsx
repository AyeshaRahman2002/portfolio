...
const artistLinks = [
  ['INDEX', '/'], ['WORK', '/work'], ['SKILLS', '/skills'], ['ABOUT', '/about'],
] as const;
...
export function Navigation() {
  ...
  return (
    <header className={`site-nav site-nav--${mode} sticky top-0 z-50 border-b border-[var(--border-subtle)] bg-[color:var(--bg-primary)]/95`}>
