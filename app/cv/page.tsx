...
export default function CVPage() {
  ...
  const pdfUrl = withBasePath('/documents/Ayesha_Rahman_CV.pdf');
  return (
    <article className="page max-w-5xl">
      <header className="section !pt-0 border-b border-[var(--border-strong)]"><p className="eyebrow">CURRICULUM VITAE</p><h1 className="section-title mt-8">{PERSONAL_INFO.name}</h1><p className="mt-5 font-mono text-xs">AI / MACHINE LEARNING ENGINEER · JEDDAH, SAUDI ARABIA</p>{hasPdf && <div className="mt-8 flex flex-wrap gap-6"><a href={pdfUrl} target="_blank" rel="noreferrer" className="text-link">Open current CV ↗</a><a href={pdfUrl} download="Ayesha_Rahman_CV.pdf" className="text-link">Download PDF ↧</a></div>}</header>
      <CVSection title="PROFILE"><p>AI and machine learning engineer with an MEng in Computer Science with Artificial Intelligence, specialising in secure and scalable AI systems across cybersecurity, cloud infrastructure, fintech and data-driven applications. Experienced in behavioural modelling, continuous behaviour monitoring, behavioural telemetry, production machine learning pipelines, privacy-preserving learning, federated learning, anomaly detection, secure APIs and cloud platforms. Current work spans CyberSaR / KAUST research and AI and software engineering at Palmate Technology.</p></CVSection>
